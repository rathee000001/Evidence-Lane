...
3. **Unsigned HIL-candidate Windows artifacts.** The installer and standalone executable are intentionally not code-signed because this packaged release remains a HIL candidate and has not received final human acceptance. Verify the published SHA-256 values before launch.
